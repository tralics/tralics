...
inline Istring::Istring(const Buffer &X) : value(to_signed(the_main->SH.find(X.c_str()))) {}

inline Istring::Istring(String s) : value(to_signed(the_main->SH.find(s))) {}

inline Istring::Istring(const std::string &s) : value(to_signed(the_main->SH.find(s))) {}
