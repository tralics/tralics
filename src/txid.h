...
public:
    ...
    [[deprecated]] void add_attribute(name_positions A, name_positions B, bool force = true) const;
    [[deprecated]] void add_attribute(name_positions n, const Istring &v) const;
