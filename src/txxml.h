...
public:
    ...
    auto empty_name() const -> bool { return name.empty(); }
    ...
    auto get_cell_span() const -> int;
    auto get_first_env(name_positions name) -> Xmlp;
    auto get_id() const -> Xid { return id; }
    auto get_name() const -> Istring { return name; }
    auto has_name(Istring s) const -> bool { return name == s; }
    auto has_name(name_positions s) const -> bool { return name == the_names[s]; }
    ...
    auto is_anchor() const -> bool { return !is_xmlc() && name == the_names[np_anchor]; }
    auto is_child(Xmlp) const -> bool;
    auto is_empty() const -> bool;
    auto is_empty_p() const -> bool;
    auto is_empty_spec() const -> bool;
    auto is_xmlc() const -> bool { return id.value <= 0; }
    void kill_name() { name = Istring(); }
    auto last_addr() const -> Xmlp;
    auto last_box() -> Xmlp;
    auto last_is(name_positions) const -> bool;
    auto last_is_string() const -> bool;
    void last_to_SH();
    void make_hole(int pos);
    void move(Istring name, Xmlp res);
    void one_fig_tab(bool is_fig);
    auto only_hi() const -> bool;
    auto only_recur_hi() const -> bool;
    auto only_text() const -> bool;
    ...
    auto single_non_empty() const -> Xmlp;
    auto single_son() const -> Xmlp;
    auto size() const -> int { return tree.size(); }
    void subst_env0(Istring name, Xmlp value);
    void swap_x(Xmlp);
    auto tail_is_anchor() const -> bool;
...
public:
    ...
    auto get_value() const -> Xmlp { return value; }
