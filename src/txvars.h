...
enum {
  ...
  move_location,  makebox_location, xmlA_location, xmlB_location,
  shipout_location, leaders_location,  cleaders_location,  xleaders_location,
};
...
enum name_positions {
  ...
  np_bediteurs, np_bezier, np_biblio, np_bigcircle, 
  np_border_topw,np_border_rightw,np_border_bottomw,np_border_leftw,
  np_bottomborder, 
  ...
  np_row, np_rule, np_rule_tsa, np_rule_tsb, np_rule_bsa, np_rule_bsb, 
  np_scale, np_scaleput,np_frame,np_dashbox,
