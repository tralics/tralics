...
namespace {
    ...
    void make_names() {
        the_names.set(cst_empty, Istring(""));
        the_names.set(cst_accent, Istring("accent"));
        the_names.set(cst_accentunder, Istring("accentunder"));
        the_names.set(cst_argument, Istring("argument"));
        the_names.set(cst_biblio, Istring("thebibliography"));
        the_names.set(cst_composition, Istring("composition"));
        the_names.set(cst_displaystyle, Istring("displaystyle"));
        the_names.set(cst_document, Istring("document"));
        the_names.set(cst_elt, Istring("ELT"));
        the_names.set(cst_flaghi, Istring("'hi_flag"));
        the_names.set(cst_fonts, Istring("fonts"));
        the_names.set(cst_foot, Istring("foot"));
        the_names.set(cst_hanl, Istring("hanl"));
        the_names.set(cst_hbox, Istring("hbox"));
        the_names.set(cst_hi, Istring("hi"));
        the_names.set(cst_math, Istring("math"));
        the_names.set(cst_mathml, Istring("http://www.w3.org/1998/Math/MathML"));
        the_names.set(cst_mathvariant, Istring("mathvariant"));
        the_names.set(cst_mfenced, Istring("mfenced"));
        the_names.set(cst_mfrac, Istring("mfrac"));
        the_names.set(cst_mpadded, Istring("mpadded"));
        the_names.set(cst_mphantom, Istring("mphantom"));
        the_names.set(cst_mi, Istring("mi"));
        the_names.set(cst_mn, Istring("mn"));
        the_names.set(cst_mo, Istring("mo"));
        the_names.set(cst_ci, Istring("ci"));
        the_names.set(cst_cn, Istring("cn"));
        the_names.set(cst_csymbol, Istring("csymbol"));
        the_names.set(cst_multiscripts, Istring("mmultiscripts"));
        the_names.set(cst_nothing, Istring(""));
        the_names.set(cst_mroot, Istring("mroot"));
        the_names.set(cst_mover, Istring("mover"));
        the_names.set(cst_mrow, Istring("mrow"));
        the_names.set(cst_mrow_cst, Istring("<mrow></mrow>"));
        the_names.set(cst_mspace, Istring("mspace"));
        the_names.set(cst_msqrt, Istring("msqrt"));
        the_names.set(cst_msub, Istring("msub"));
        the_names.set(cst_mstyle, Istring("mstyle"));
        the_names.set(cst_msubsup, Istring("msubsup"));
        the_names.set(cst_msup, Istring("msup"));
        the_names.set(cst_mtable, Istring("mtable"));
        the_names.set(cst_mtd, Istring("mtd"));
        the_names.set(cst_mtext, Istring("mtext"));
        the_names.set(cst_mtr, Istring("mtr"));
        the_names.set(cst_munder, Istring("munder"));
        the_names.set(cst_mref, Istring("mref"));
        the_names.set(cst_munderover, Istring("munderover"));
        the_names.set(cst_mode, Istring("mode"));
        the_names.set(cst_display, Istring("display"));
        the_names.set(cst_nl, Istring("\n"));
        the_names.set(cst_p, Istring("p"));
        the_names.set(cst_particip, Istring("particip"));
        the_names.set(cst_rasection, Istring("RAsection"));
        the_names.set(cst_refer, Istring("refer"));
        the_names.set(cst_scriptlevel, Istring("scriptlevel"));
        the_names.set(cst_separators, Istring("separators"));
        the_names.set(cst_temporary, Istring("temporary"));
        the_names.set(cst_theorem, Istring("theorem"));
        the_names.set(cst_xmlns, Istring("xmlns"));

        the_names.set(cst_dig0, Istring("0"));
        the_names.set(cst_dig1, Istring("1"));
        the_names.set(cst_dig2, Istring("2"));
        the_names.set(cst_dig3, Istring("3"));
        the_names.set(cst_dig4, Istring("4"));
        the_names.set(cst_dig5, Istring("5"));
        the_names.set(cst_dig6, Istring("6"));
        the_names.set(cst_dig7, Istring("7"));
        the_names.set(cst_dig8, Istring("8"));
        the_names.set(cst_dig9, Istring("9"));

        the_names.set(cstb_article, Istring("article"));
        the_names.set(cstb_book, Istring("book"));
        the_names.set(cstb_booklet, Istring("booklet"));
        the_names.set(cstb_conference, Istring("conference"));
        the_names.set(cstb_coursenotes, Istring("coursenotes"));
        the_names.set(cstb_comment, Istring("comment"));
        the_names.set(cstb_extension, Istring("extension"));
        the_names.set(cstb_inbook, Istring("inbook"));
        the_names.set(cstb_incollection, Istring("incollection"));
        the_names.set(cstb_inproceedings, Istring("inproceedings"));
        the_names.set(cstb_manual, Istring("manual"));
        the_names.set(cstb_masterthesis, Istring("mastersthesis")); // \todo why swap?
        the_names.set(cstb_mastersthesis, Istring("masterthesis")); // \todo why swap?
        the_names.set(cstb_misc, Istring("misc"));
        the_names.set(cstb_phdthesis, Istring("phdthesis"));
        the_names.set(cstb_proceedings, Istring("proceedings"));
        the_names.set(cstb_preamble, Istring("preamble"));
        the_names.set(cstb_techreport, Istring("techreport"));
        the_names.set(cstb_string, Istring("string"));
        the_names.set(cstb_unpublished, Istring("unpublished"));
        the_names.set(cstb_unknown, Istring("unknown"));
        the_names.set(cstb_address, Istring("address"));
        the_names.set(cstb_author, Istring("author"));
        the_names.set(cstb_booktitle, Istring("booktitle"));
        the_names.set(cstb_chapter, Istring("chapter"));
        the_names.set(cstb_crossref, Istring("crossref"));
        the_names.set(cstb_doi, Istring("doi"));
        the_names.set(cstb_edition, Istring("edition"));
        the_names.set(cstb_editor, Istring("editor"));
        the_names.set(cstb_howpublished, Istring("howpublished"));
        the_names.set(cstb_institution, Istring("institution"));
        the_names.set(cstb_isbn, Istring("isbn"));
        the_names.set(cstb_issn, Istring("issn"));
        the_names.set(cstb_isrn, Istring("isrn"));
        the_names.set(cstb_journal, Istring("journal"));
        the_names.set(cstb_key, Istring("key"));
        the_names.set(cstb_month, Istring("month"));
        the_names.set(cstb_language, Istring("language"));
        the_names.set(cstb_langue, Istring("langue"));
        the_names.set(cstb_note, Istring("note"));
        the_names.set(cstb_number, Istring("number"));
        the_names.set(cstb_organization, Istring("organization"));
        the_names.set(cstb_pages, Istring("pages"));
        the_names.set(cstb_publisher, Istring("publisher"));
        the_names.set(cstb_school, Istring("school"));
        the_names.set(cstb_series, Istring("series"));
        the_names.set(cstb_title, Istring("title"));
        the_names.set(cstb_type, Istring("type"));
        the_names.set(cstb_url, Istring("url"));
        the_names.set(cstb_volume, Istring("volume"));
        the_names.set(cstb_year, Istring("year"));
        the_names.set(cstb_equipe, Istring("equipe"));
        the_names.set(cstb_subtype, Istring("subtype"));
        the_names.set(cstb_unite, Istring("unite"));
        the_names.set(cstb_statut, Istring("statut"));
        the_names.set(cstb_section, Istring("section"));
        the_names.set(cst_numalign, Istring("numalign"));
        the_names.set(cst_denalign, Istring("denomalign"));

        the_names.set(cstf_normal, Istring("normal"));
        the_names.set(cstf_upright, Istring());
        the_names.set(cstf_bold, Istring("bold"));
        the_names.set(cstf_italic, Istring("italic"));
        the_names.set(cstf_bold_italic, Istring("bold-italic"));
        the_names.set(cstf_script, Istring("script"));
        the_names.set(cstf_bold_script, Istring("bold-script"));
        the_names.set(cstf_fraktur, Istring("fraktur"));
        the_names.set(cstf_doublestruck, Istring("double-struck"));
        the_names.set(cstf_bold_fraktur, Istring("bold-fraktur"));
        the_names.set(cstf_sansserif, Istring("sans-serif"));
        the_names.set(cstf_bold_sansserif, Istring("bold-sans-serif"));
        the_names.set(cstf_sansserif_italic, Istring("sans-serif-italic"));
        the_names.set(cstf_sansserif_bold_italic, Istring("sans-serif-bold-italic"));
        the_names.set(cstf_monospace, Istring("monospace"));

        the_names.set(np_a1, Istring("a1"));
        the_names.set(np_a2, Istring("a2"));
        the_names.set(np_abarnodeconnect, Istring("abarnodeconnect"));
        the_names.set(np_accueil, Istring("accueil"));
        the_names.set(np_affiliation, Istring("affiliation"));
        the_names.set(np_allowbreak, Istring("allowbreak"));
        the_names.set(np_alt_head, Istring("alt_head"));
        the_names.set(np_alt_caption, Istring("alt_head"));
        the_names.set(np_alt_section, Istring("alt_head"));
        the_names.set(np_anchor, Istring("anchor"));
        the_names.set(np_angle, Istring("angle"));
        the_names.set(np_anodeconnect, Istring("anodeconnect"));
        the_names.set(np_anodecurve, Istring("anodecurve"));
        the_names.set(np_arc, Istring("pic-arc"));
        the_names.set(np_arg1, Istring("arg1"));
        the_names.set(np_arg2, Istring("arg2"));
        the_names.set(np_arg3, Istring("arg3"));
        the_names.set(np_array, Istring("array"));
        the_names.set(np_alternatives, Istring("alternatives"));

        the_names.set(np_b1, Istring("b1"));
        the_names.set(np_b2, Istring("b2"));
        the_names.set(np_b_rend, Istring("rend"));
        the_names.set(np_backmatter, Istring("backmatter"));
        the_names.set(np_bauteurs, Istring("bauteurs"));
        the_names.set(np_barnodeconnect, Istring("barnodeconnect"));
        the_names.set(np_bediteurs, Istring("bediteur"));
        the_names.set(np_bezier, Istring("pic-bezier"));
        the_names.set(np_biblio, Istring("biblio"));
        the_names.set(np_bigcircle, Istring("pic-bigcircle"));
        the_names.set(np_bottomborder, Istring("bottom-border"));
        the_names.set(np_border_bottomw, Istring("border-bottom-width"));
        the_names.set(np_border_topw, Istring("border-top-width"));
        the_names.set(np_border_leftw, Istring("border-left-width"));
        the_names.set(np_border_rightw, Istring("border-right-width"));

        the_names.set(np_box, Istring("pic-framebox"));
        the_names.set(np_box_pos, Istring("position"));
        the_names.set(np_boxed, Istring("boxed"));
        the_names.set(np_bpers, Istring("bpers"));
        the_names.set(np_box_width, Istring("width"));
        the_names.set(np_bibitem, Istring("bibitem"));
        the_names.set(np_bibkey, Istring("bib-key"));

        the_names.set(np_c1, Istring("c1"));
        the_names.set(np_c2, Istring("c2"));
        the_names.set(np_c_left, Istring("left"));
        the_names.set(np_c_right, Istring("right"));
        the_names.set(np_c_center, Istring("center"));
        the_names.set(np_caption, Istring("caption"));
        the_names.set(np_captions, Istring("head"));
        the_names.set(np_catperso, Istring("catperso"));
        the_names.set(np_cell, Istring("cell"));
        the_names.set(np_center, Istring("center"));
        the_names.set(np_center_etc, Istring("center"));
        the_names.set(np_center_etc1, Istring("center"));
        the_names.set(np_center_etc2, Istring("quoted"));
        the_names.set(np_center_etc3, Istring("quoted"));
        the_names.set(np_center_etc4, Istring("flushed-left"));
        the_names.set(np_center_etc5, Istring("flushed-right"));
        the_names.set(np_center_etc6, Istring("verse"));
        the_names.set(np_centered, Istring("centered"));
        the_names.set(np_chapters, Istring("chapters"));
        the_names.set(np_circle, Istring("pic-circle"));
        the_names.set(np_natcit, Istring("Cit"));
        the_names.set(np_cit, Istring("cit"));
        the_names.set(np_cite_type, Istring("type"));
        the_names.set(np_citation, Istring("citation"));
        the_names.set(np_cleaders, Istring("cleaders"));
        the_names.set(np_clip, Istring("clip"));
        the_names.set(np_close, Istring("close"));
        the_names.set(np_closecurve, Istring("pic-closecurve"));
        the_names.set(np_columnalign, Istring("columnalign"));
        the_names.set(np_columnspan, Istring("columnspan"));
        the_names.set(np_pagecolor, Istring("pagecolor"));
        the_names.set(np_color, Istring("color"));
        the_names.set(np_color2, Istring("color2"));
        the_names.set(np_cols, Istring("cols"));
        the_names.set(np_cst_width, Istring("width"));
        the_names.set(np_curve, Istring("pic-curve"));
        the_names.set(np_curve_nbpts, Istring("nbsymb"));

        the_names.set(np_dashbox, Istring("pic-dashbox"));
        the_names.set(np_dashline, Istring("dashline"));
        the_names.set(np_dashdim, Istring("dashdim"));
        the_names.set(np_depth, Istring("depth"));
        the_names.set(np_depthA, Istring("depthA"));
        the_names.set(np_depthB, Istring("depthB"));
        the_names.set(np_description, Istring("description"));
        the_names.set(np_display, Istring("display"));
        the_names.set(cst_div0, Istring("div0"));
        the_names.set(cst_div1, Istring("div1"));
        the_names.set(cst_div2, Istring("div2"));
        the_names.set(cst_div3, Istring("div3"));
        the_names.set(cst_div4, Istring("div4"));
        the_names.set(cst_div5, Istring("div5"));
        the_names.set(cst_div6, Istring("div6"));
        the_names.set(np_div0, Istring("div0"));
        the_names.set(np_div1, Istring("div1"));
        the_names.set(np_div2, Istring("div2"));
        the_names.set(np_div3, Istring("div3"));
        the_names.set(np_div4, Istring("div4"));
        the_names.set(np_div5, Istring("div5"));
        the_names.set(np_div6, Istring("div6"));
        the_names.set(np_dottedline, Istring("dottedline"));
        the_names.set(np_drawline, Istring("drawline"));
        the_names.set(np_dx, Istring("dx"));
        the_names.set(np_dy, Istring("dy"));

        the_names.set(np_encap, Istring("encap"));
        the_names.set(np_english, Istring("english"));
        the_names.set(np_eqnpos, Istring("eqnpos"));
        the_names.set(np_error, Istring("error"));
        the_names.set(np_Error, Istring("Error"));
        the_names.set(np_warning, Istring(""));
        the_names.set(np_Warning, Istring("Warning"));
        the_names.set(np_Info, Istring("Info"));
        the_names.set(np_inline, Istring("inline"));

        the_names.set(np_false, Istring("false"));
        the_names.set(np_fbox, Istring("fbox"));
        the_names.set(np_figure, Istring("figure"));
        the_names.set(np_file, Istring("file"));
        the_names.set(np_fileextension, Istring("extension"));
        the_names.set(np_float, Istring("float"));
        the_names.set(np_float_figure, Istring("figure"));
        the_names.set(np_float_table, Istring("table"));
        the_names.set(np_font_bold, Istring("bold"));
        the_names.set(np_font_boldextended, Istring("boldextended"));
        the_names.set(np_font_semibold, Istring("semibold"));
        the_names.set(np_font_condensed, Istring("condensed"));
        the_names.set(np_font_it, Istring("it"));
        the_names.set(np_font_large, Istring("large"));
        the_names.set(np_font_large1, Istring("large1"));
        the_names.set(np_font_large2, Istring("large2"));
        the_names.set(np_font_large3, Istring("large3"));
        the_names.set(np_font_large4, Istring("large4"));
        the_names.set(np_font_large5, Istring("large5"));
        the_names.set(np_font_large6, Istring("large6"));
        the_names.set(np_font_medium, Istring("medium"));
        the_names.set(np_font_normalsize, Istring("normalsize"));
        the_names.set(np_font_roman, Istring("roman"));
        the_names.set(np_font_sansserif, Istring("sansserif"));
        the_names.set(np_font_sc, Istring("sc"));
        the_names.set(np_font_slanted, Istring("slanted"));
        the_names.set(np_font_small, Istring("small"));
        the_names.set(np_font_small1, Istring("small1"));
        the_names.set(np_font_small2, Istring("small2"));
        the_names.set(np_font_small3, Istring("small3"));
        the_names.set(np_font_small4, Istring("small4"));
        the_names.set(np_font_small5, Istring("small5"));
        the_names.set(np_font_small6, Istring("small6"));
        the_names.set(np_font_tt, Istring("tt"));
        the_names.set(np_font_upright, Istring("upright"));
        the_names.set(np_footnote, Istring("note"));
        the_names.set(np_form, Istring("form"));
        the_names.set(np_formula, Istring("formula"));
        the_names.set(np_foot, Istring("foot"));
        the_names.set(np_frame, Istring("pic-frame"));
        the_names.set(np_framed, Istring("framed"));
        the_names.set(np_french, Istring("french"));
        the_names.set(np_from, Istring("from"));
        the_names.set(np_frontmatter, Istring("frontmatter"));
        the_names.set(np_full, Istring("full"));
        the_names.set(np_full_first, Istring("prenomcomplet"));

        the_names.set(np_german, Istring("german"));
        the_names.set(np_glo_name, Istring("Glossary"));
        the_names.set(np_gloss, Istring("gloss"));
        the_names.set(np_graphics, Istring("graphics"));

        the_names.set(np_halfem, Istring("4.pt"));
        the_names.set(np_halign, Istring("halign"));
        the_names.set(np_hdr, Istring("hdr"));
        the_names.set(np_head, Istring("head"));
        the_names.set(np_header, Istring("headings"));
        the_names.set(np_height, Istring("height"));
        the_names.set(np_hfil, Istring("hfil"));
        the_names.set(np_hfill, Istring("hfill"));
        the_names.set(np_hfilneg, Istring("hfilneg"));
        the_names.set(np_html, Istring("html"));
        the_names.set(np_hss, Istring("hss"));

        the_names.set(np_id, Istring("id"));
        the_names.set(np_idtext, Istring("id-text"));
        the_names.set(np_index, Istring("index"));
        the_names.set(np_glossary, Istring("glossary"));
        the_names.set(np_inline, Istring("inline"));
        the_names.set(np_isproject, Istring("isproject"));
        the_names.set(np_item, Istring("item"));

        the_names.set(np_junior, Istring("junior"));

        the_names.set(np_key, Istring("key"));
        the_names.set(np_keywords, Istring("keywords"));

        the_names.set(np_label_glo, Istring("label"));
        the_names.set(np_label_item, Istring("label"));
        the_names.set(np_language, Istring());
        the_names.set(np_leaders, Istring("leaders"));
        the_names.set(np_left, Istring("left"));
        the_names.set(np_leftborder, Istring("left-border"));
        the_names.set(np_leg, Istring("leg"));
        the_names.set(np_level, Istring("level"));
        the_names.set(np_linethickness, Istring("linethickness"));
        the_names.set(np_lineC, Istring("line"));
        the_names.set(np_line, Istring("pic-line"));
        the_names.set(np_line_thickness, Istring("pic-linethickness"));
        the_names.set(np_list, Istring("list"));
        the_names.set(np_llap, Istring("llap"));
        the_names.set(np_rlap, Istring("rlap"));
        the_names.set(np_rasection, Istring(""));

        the_names.set(np_mainmatter, Istring("mainmatter"));
        the_names.set(np_mbox, Istring("mbox"));
        the_names.set(np_marginpar, Istring("marginpar"));
        the_names.set(np_minipage, Istring("minipage"));
        the_names.set(np_minipage_width, Istring("width"));
        the_names.set(np_module, Istring("module"));
        the_names.set(np_moreinfo, Istring("moreinfo"));
        the_names.set(np_movablelimits, Istring("movablelimits"));
        the_names.set(np_multiput, Istring("pic-multiput"));

        the_names.set(np_name, Istring("name"));
        the_names.set(np_nameA, Istring("nameA"));
        the_names.set(np_nameB, Istring("nameB"));

        the_names.set(np_node, Istring("node"));
        the_names.set(np_nodebox, Istring("nodebox"));
        the_names.set(np_nodecircle, Istring("nodecircle"));
        the_names.set(np_nodeconnect, Istring("nodeconnect"));
        the_names.set(np_nodecurve, Istring("nodecurve"));
        the_names.set(np_nodeoval, Istring("nodeoval"));
        the_names.set(np_nodetriangle, Istring("nodetriangle"));
        the_names.set(np_noindent, Istring("noindent"));
        the_names.set(np_nom, Istring("nom"));
        the_names.set(np_nonumber, Istring("nonumber"));

        the_names.set(np_open, Istring("open"));
        the_names.set(np_ordered, Istring("ordered"));
        the_names.set(np_oval, Istring("pic-oval"));
        the_names.set(np_overline, Istring("overline"));

        the_names.set(np_page, Istring("page"));
        the_names.set(np_part, Istring("part"));
        the_names.set(np_part0, Istring("participant"));
        the_names.set(np_part1, Istring("participante"));
        the_names.set(np_part2, Istring("participantes"));
        the_names.set(np_part3, Istring("participants"));
        the_names.set(np_particle, Istring("part"));
        the_names.set(np_pers, Istring("pers"));
        the_names.set(np_place, Istring("place"));
        the_names.set(np_picture, Istring("picture"));
        the_names.set(np_point, Istring("point"));
        the_names.set(np_pos, Istring("pos"));
        the_names.set(np_posA, Istring("posA"));
        the_names.set(np_posB, Istring("posB"));
        the_names.set(np_posi, Istring("inner-pos"));
        the_names.set(np_pre, Istring("pre"));
        the_names.set(np_prefix, Istring("prefix"));
        the_names.set(np_prenom, Istring("prenom"));
        the_names.set(np_prenote, Istring("prenote"));
        the_names.set(np_profession, Istring("profession"));
        the_names.set(np_research_centre, Istring("research-centre"));
        the_names.set(np_projet, Istring("projet"));
        the_names.set(np_projetdeveloppe, Istring("projetdeveloppe"));
        the_names.set(np_put, Istring("pic-put"));

        the_names.set(np_quoted, Istring("quoted"));

        the_names.set(np_r_angle, Istring("angle"));
        the_names.set(np_raisebox, Istring("raisebox"));
        the_names.set(np_ref, Istring("ref"));
        the_names.set(np_rend, Istring("rend"));
        the_names.set(np_repeat, Istring("repeat"));
        the_names.set(np_right, Istring("right"));
        the_names.set(np_rightborder, Istring("right-border"));
        the_names.set(np_rotatebox, Istring("pic-rotatebox"));
        the_names.set(np_row, Istring("row"));
        the_names.set(np_rule, Istring("rule"));
        the_names.set(np_rule_tsa, Istring("top_rule_space_above"));
        the_names.set(np_rule_tsb, Istring("top_rule_space_below"));
        the_names.set(np_rule_bsa, Istring("bottom_rule_space_above"));
        the_names.set(np_rule_bsb, Istring("bottom_rule_space_below"));
        the_names.set(np_rclist, Istring("UR"));
        the_names.set(np_rcval, Istring("+UR"));

        the_names.set(np_sbox, Istring("scalebox"));
        the_names.set(np_sc, Istring("sc"));
        the_names.set(np_scale, Istring("scale"));
        the_names.set(np_scaleput, Istring("pic-scaleput"));
        the_names.set(np_s_caps, Istring("caps"));
        the_names.set(np_s_hl, Istring("hl"));
        the_names.set(np_s_old, Istring("oldstyle"));
        the_names.set(np_s_scale, Istring("scale"));
        the_names.set(np_s_so, Istring("so"));
        the_names.set(np_s_st, Istring("st"));
        the_names.set(np_s_sub, Istring("sub"));
        the_names.set(np_s_sup, Istring("sup"));
        the_names.set(np_s_ul, Istring("ul"));
        the_names.set(np_separator, Istring(""));
        the_names.set(np_simple, Istring("simple"));
        the_names.set(np_simplemath, Istring("simplemath"));
        the_names.set(np_size, Istring("size"));
        the_names.set(np_spaceafter, Istring("spaceafter"));
        the_names.set(np_spacebefore, Istring("spacebefore"));
        the_names.set(np_specs, Istring("specs"));
        the_names.set(np_style, Istring("style"));
        the_names.set(np_starred, Istring("starred"));
        the_names.set(np_subfigure, Istring("subfigure"));
        the_names.set(np_stylesheet, Istring(""));
        the_names.set(np_stylesheet_type, Istring("text/css"));

        the_names.set(np_table, Istring("table"));
        the_names.set(np_Table, Istring("Table"));
        the_names.set(np_tabular, Istring("tabular"));
        the_names.set(np_tabular_star, Istring("tabular*"));
        the_names.set(np_tab_width, Istring("width"));
        the_names.set(np_tagcurve, Istring("pic-tagcurve"));
        the_names.set(np_target, Istring("target"));
        the_names.set(np_term, Istring("term"));
        the_names.set(np_texte, Istring("texte"));
        the_names.set(np_texmath, Istring("texmath"));
        the_names.set(np_theindex, Istring("theindex"));
        the_names.set(np_theglossary, Istring("theglossary"));
        the_names.set(np_theme, Istring("theme"));
        the_names.set(np_theorem, Istring(""));
        the_names.set(np_thick_lines, Istring("pic-thicklines"));
        the_names.set(np_thin_lines, Istring("pic-thinlines"));
        the_names.set(np_toc, Istring("tableofcontents"));
        the_names.set(np_toc1, Istring("listoftables"));
        the_names.set(np_toc2, Istring("listoffigures"));
        the_names.set(np_topborder, Istring("top-border"));
        the_names.set(np_totalwidth, Istring("totalwidth"));
        the_names.set(np_true, Istring("true"));
        the_names.set(np_type, Istring("type"));
        the_names.set(np_textype, Istring("textype"));

        the_names.set(np_underline, Istring("underline"));
        the_names.set(np_unknown, Istring("unknown"));
        the_names.set(np_unit_length, Istring("unit-length"));
        the_names.set(np_url, Istring("url"));
        the_names.set(np_userid, Istring("userid"));
        the_names.set(np_user_list, Istring("description"));

        the_names.set(np_val, Istring("val"));
        the_names.set(np_vector, Istring("pic-vector"));
        the_names.set(np_vfil, Istring("vfil"));
        the_names.set(np_vfill, Istring("vfill"));
        the_names.set(np_vfilneg, Istring("vfilneg"));
        the_names.set(np_vpos, Istring("vpos"));
        the_names.set(np_vss, Istring("vss"));

        the_names.set(np_width, Istring("width"));

        the_names.set(np_xscale, Istring("xscale"));
        the_names.set(np_xscaley, Istring("xscaley"));
        the_names.set(np_xdir, Istring("xdir"));
        the_names.set(np_xleaders, Istring("xleaders"));
        the_names.set(np_xpos, Istring("xpos"));
        the_names.set(np_xref, Istring("xref"));

        the_names.set(np_yscale, Istring("yscale"));
        the_names.set(np_yscalex, Istring("yscalex"));
        the_names.set(np_ydir, Istring("ydir"));
        the_names.set(np_ypos, Istring("ypos"));

        the_names.set(np_zerodim, Istring("0pt"));
        the_names.set(np_mml_normal, Istring("mml@font@normal"));
        the_names.set(np_mml_upright, Istring("mml@font@upright"));
        the_names.set(np_mml_bold, Istring("mml@font@bold"));
        the_names.set(np_mml_italic, Istring("mml@font@italic"));
        the_names.set(np_mml_bold_italic, Istring("mml@font@bolditalic"));
        the_names.set(np_mml_script, Istring("mml@font@script"));
        the_names.set(np_mml_bold_script, Istring("mml@font@boldscript"));
        the_names.set(np_mml_fraktur, Istring("mml@font@fraktur"));
        the_names.set(np_mml_doublestruck, Istring("mml@font@doublestruck"));
        the_names.set(np_mml_bold_fraktur, Istring("mml@font@boldfraktur"));
        the_names.set(np_mml_sansserif, Istring("mml@font@sansserif"));
        the_names.set(np_mml_bold_sansserif, Istring("mml@font@boldsansserif"));
        the_names.set(np_mml_sansserif_italic, Istring("mml@font@sansserifitalic"));
        the_names.set(np_mml_sansserif_bold_italic, Istring("mml@font@sansserifbolditalic"));
        the_names.set(np_mml_monospace, Istring("mml@font@monospace"));

        the_names.set(np_3pt, Istring("3pt"));
        the_names.set(np_6pt, Istring("6pt"));
        the_names.set(np_12pt, Istring("12pt"));
        the_names.set(np_letters_tl, Istring("tl"));
        the_names.set(np_letters_tr, Istring("tr"));
        the_names.set(np_letters_bl, Istring("bl"));
        the_names.set(np_letters_br, Istring("br"));
