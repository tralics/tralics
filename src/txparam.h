...
public:
  ...
  auto get_bibtex_extensions() -> vector<Istring> & {
    return bibtex_extensions;
  }
  auto get_bibtex_extensions_s() -> vector<Istring> & {
    return bibtex_extensions_s;
  }
  ...
  auto get_output_encoding() const -> output_encoding_type {
