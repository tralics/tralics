...
public:
    ...
    static void        print_cmd_chr(CmdChr);
    void               remove_junk();
    ...
    static auto        expand_mac_inner(const TokenList &W, TokenList *) -> TokenList;
...
private:
    ...
    static auto dimen_attrib(ScaledInt) -> Istring;
    ...
    void        make_catcodes();
    static auto make_cit_ref(Istring, Istring) -> Xml *;
    void        make_constants();
    void        makelabel();
