...
struct Hashtab : public std::vector<std::string> {
    ...
    Token par_token, OB_token, CB_token, dollar_token, verb_token, noindent_token, textvisiblespace_token, frozen_dont_expand, relax_token,
        ...
        endgroup_token, allowbreak_token, stepcounter_token, nomathsw0_token, nomathsw1_token, xkv_tfam_token, xkv_header_token,
        xkv_tkey_token, empty_token, composite_token, ExplFileName_token, ExplFileDate_token, ExplFileVersion_token,
