...
enum subtypes {
  ...
  // for last_item
  lastpenalty_code = 0,
  lastkern_code, lastskip_code,
  inputlineno_code,badness_code,  xmlcurrentid_code,xmllastid_code,
  xmlAid_code, xmlBid_code, XMLboxname_code, XMLboxid_code,
  xmlAname_code,xmlBname_code,
  xmlAsize_code,xmlcurarray_code,xmlcurcell_code,xmlcurrow_code,
